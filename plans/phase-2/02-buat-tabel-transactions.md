# Langkah 2: Buat Tabel Transaksi

**Tujuan:** Menyiapkan tabel di PostgreSQL untuk menyimpan data hasil ekstraksi NLP.
**Target Implementator:** Junior Programmer / AI Model.

## Langkah-langkah Implementasi:

1. **Edit Skrip Migrasi**:
   Buka file `src/db/migrate.ts`. Kita akan menambahkan query untuk membuat tabel `transactions`.
2. **Tambahkan Query Tabel `transactions`**:
   Ubah isi `createTables` menjadi seperti ini:
   ```typescript
